...
public class SlotUnitCrusherQueue extends SlotUnitCrusherInput {

	private int queueId;

	public SlotUnitCrusherQueue(TileTable table, Page page, int id, int x, int y, Unit unit, int queueId) {
