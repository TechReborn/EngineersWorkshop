package engineers.workshop.temp;
...
public class AssemblyContainerHelper implements ModInitializer {
	...
	public static final Identifier OPEN_CONTAINER = new Identifier("engineersworkshop", "open_container");
	...
	public static void init() {
		...
		addContainerMapping(new Identifier("engineersworkshop", "table"), DEFAULT_CONTAINER_SUPPLIER, (playerEntity, pos) -> new GuiTable((TileTable) playerEntity.world.getBlockEntity(pos), playerEntity));
